...
import '../../dtos/chat/chat_message_dto.dart';
import '../../dtos/chat/chat_room_create_request_dto.dart';
import '../../dtos/chat/chat_room_list_item_dto.dart';
import '../../dtos/chat/chat_room_response_dto.dart';
...
class ChatRepository {
  ...
  Future<ChatRoomResponseDto> createOrGetChatRoom(
    ...
    final response =
        await _dio.post('/api/chat/rooms', data: requestDto.toJson());
  ...
  Future<void> connectStomp(int chatRoomId, String jwtToken) async {
    ...
    _stompClient = StompClient(
      config: StompConfig(
        ...
        onStompError: (frame) {
          print(
              '[ChatRepository] STOMP 프로토콜 에러: ${frame.headers} - ${frame.body}');
        },
        onDisconnect: (frame) {
