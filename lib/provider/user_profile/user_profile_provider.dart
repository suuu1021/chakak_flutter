...
class UserProfileNotifier extends StateNotifier<UserProfileState> {
  ...
  Future<void> loadMyProfile() async {
    try {
      ...
      print(
          '[DEBUG] UserProfileNotifier.loadMyProfile 호출 - isLogin: ${session.isLogin}, userTypeCode: ${session.userTypeCode}');
    ...
    try {
      ...
      state =
          state.copyWith(isLoading: false, errorMessage: '프로필을 불러오는데 실패했습니다.');
    }
  }
  ...
  Future<bool> createProfile(UserProfileCreateRequestDto request) async {
    try {
      ...
      state =
          state.copyWith(isCreating: false, errorMessage: '프로필 생성에 실패했습니다.');
      return false;
    }
  }
  ...
  Future<bool> updateProfile(UserProfileUpdateRequestDto request) async {
    try {
      ...
      state = state.copyWith(
          isUpdating: false, errorMessage: '프로필 수정에 실패했습니다: ${e.toString()}');
      return false;
    }
  }
